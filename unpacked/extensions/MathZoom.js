 ...
 */ (function (HUB, HTML, AJAX, HTMLCSS, nMML) {
    ...
    var ZOOM = MathJax.Extension.MathZoom = {
        ...
        Zoom: function (event, math) {
            ...
            if (zoom.offsetWidth < Mw && zoom.offsetHeight < Mh) {
        ...
        Position: function (zoom, bbox) {
            var XY = this.Resize(),
                ...
                y = XY.y,
                W = bbox.mW;
            var dx = -Math.floor((zoom.offsetWidth - W) / 2),
                dy = bbox.Y;
    ...
    MathJax.Callback.Queue(
        ["StartupHook", MathJax.Hub.Register, "Begin Styles", {}], ["Styles", AJAX, CONFIG.styles], ["Post", HUB.Startup.signal, "MathZoom Ready"], ["loadComplete", AJAX, "[MathJax]/extensions/MathZoom.js"]);
